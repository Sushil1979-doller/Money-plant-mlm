...
function openModal(modalId) {
  ...
  // यदि Activate Modal खोल रहे हैं, तो uplines को री-लोड करें
  if(modalId === 'activateModal'){
    loadUplines();
  }
  // यदि Team Modal खोल रहे हैं, तो team levels को री-लोड करें
...
function loadUplines() {
  ...
  if(uplineList){
    uplineList.innerHTML = ''; // Reset before loading
    for (let i = 15; i >= 1; i--) {
