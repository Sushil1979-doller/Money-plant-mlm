...
const faqData = [
  // (सभी 25 FAQ items यहाँ जस के तस, English + Hindi)
  {
    en: {
...
function distributeFunds() {
  // Distribute button hidden
  document.querySelector('.distribute-btn').style.display = 'none';

  // Referral Link & Telegram buttons shown AFTER distribution
...
function openReplaceModal() {
  // Set sponsor link above newAddress
